...
# or from src:
# Set-ExecutionPolicy RemoteSigned -Scope CurrentUser -Force; irm https://raw.githubusercontent.com/tania-andersen/Skraepper/main/tests/test_skraepper.ps1 | iex
